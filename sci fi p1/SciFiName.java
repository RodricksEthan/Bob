...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        int scifiOrigin = (int)(Math.random()*relativeName1.length())+1;
        String scifiPlace = relativeName1.substring(scifiOrigin);
        scifiOrigin = (int)(Math.random()*relativeName2.length())+1;
        scifiPlace += relativeName2.substring(scifiOrigin);
        System.out.println("Hello " + scifiFirst + " " + scifiLast + " of " +  scifiPlace);
